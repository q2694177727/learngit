...
) ENGINE=InnoDB  DEFAULT CHARSET=gbk COMMENT='文章表' AUTO_INCREMENT=71 ;
...
(23, '测试添加文章 使用模型12', '删除全部的图后开始测试添加文章', '8', 1, '2018-07-20 11:13:34', '3', '6', 51, '', 1, 1),
...
(44, '测试', '测试测试', '8.1', 1, '2018-07-23 16:09:47', '34', '2', 50, '测试测试测试测试测试', 1, 0),
...
) ENGINE=InnoDB  DEFAULT CHARSET=gbk COMMENT='文章内容表' AUTO_INCREMENT=65 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=gbk COMMENT='文章图片' AUTO_INCREMENT=85 ;
...
(84, '20180831\\1c6a179062675f06bfcc46dd8ee16c3e.jpg', './file/upload', 63, '2018-08-31 03:09:57');
...
CREATE TABLE IF NOT EXISTS `bg_article_type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=gbk COMMENT='文章标签' AUTO_INCREMENT=12 ;
...
(10, '数据库', 'mysql', '2018-08-31 02:50:38', 'e153', '20180831\\09ee7e5b8809393d71139b0d1760c66e.png'),
(11, 'VUE', 'vue学习', '2018-08-31 03:05:33', '136850', '20180831\\33d16b022c732705e58e5ee4e5a9c0bb.jpg');
...
CREATE TABLE IF NOT EXISTS `bg_article_type_tags` (
  ...
  KEY `article_id` (`article_id`),
  KEY `type_id` (`type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=gbk COMMENT='文章标签表' AUTO_INCREMENT=85 ;
...
(76, 68, 2, '2018-08-31 03:04:24'),
(77, 68, 3, '2018-08-31 03:04:24'),
(78, 68, 8, '2018-08-31 03:04:24'),
(79, 68, 10, '2018-08-31 03:04:24'),
(80, 69, 3, '2018-08-31 03:09:57'),
(81, 69, 5, '2018-08-31 03:09:57'),
(82, 69, 11, '2018-08-31 03:09:57'),
(83, 70, 2, '2018-08-31 03:29:03'),
(84, 70, 3, '2018-08-31 03:29:03');
...
CREATE TABLE IF NOT EXISTS `bg_message_down` (
  ...
  `article_id` int(11) NOT NULL,
  PRIMARY KEY (`down_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='点赞表' AUTO_INCREMENT=32 ;
...
(23, '', 's possible your PC or network is sending automatic', '2018-08-24 08:05:34', 66),
(31, '127.0.0.1', 'XX内网IP', '2018-08-31 03:21:22', 69);
...
CREATE TABLE IF NOT EXISTS `bg_pic_dir` (
  ...
  KEY `article_id` (`article_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=gbk COMMENT='图片地址表' AUTO_INCREMENT=17 ;
...
(16, 1, 'Linux上传文件图片测试', '20180824\\8ac5a32a61c08c889b726cbd8355d026.jpg', '2018-08-24 07:16:56', 66);
